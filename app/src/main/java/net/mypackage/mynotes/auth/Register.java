package net.mypackage.mynotes.auth;
...
import net.mypackage.mynotes.MainActivity;
import net.mypackage.mynotes.R;
        ...
        syncAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(uUserPass.length() < 6){
                    Toast.makeText(Register.this, "Passwords must be at least 6 characters.", Toast.LENGTH_SHORT).show();
                }

                if(uUserEmail.isEmpty() || uUsername.isEmpty() || uUserPass.isEmpty() || uConfPass.isEmpty()){
                    rUserEmail.setError("You can't leave this empty");
                    rUserName.setError("You can't leave this empty");
                    rUserPass.setError("You can't leave this empty");
                    rUserConfPass.setError("You can't leave this empty");
                    return;
                }
