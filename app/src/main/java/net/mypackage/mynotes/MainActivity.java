...
import net.mypackage.mynotes.auth.Login;
import net.mypackage.mynotes.auth.Register;
import net.mypackage.mynotes.model.Adapter;
import net.mypackage.mynotes.model.Note;
import net.mypackage.mynotes.note.AddNote;
import net.mypackage.mynotes.note.EditNote;
import net.mypackage.mynotes.note.NoteDetails;
